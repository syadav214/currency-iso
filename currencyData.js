module.exports = {
  ...
  ALL: { isoCode: '008', fractionDigit: 2, currencyName: 'Lek', countries: ['Albania'] },
  AMD: {
    isoCode: '051',
    fractionDigit: 2,
  ...
  AOA: { isoCode: '973', fractionDigit: 2, currencyName: 'Kwanza', countries: ['Angola'] },
  ARS: {
    isoCode: '032',
    fractionDigit: 2,
  ...
  BWP: { isoCode: '072', fractionDigit: 2, currencyName: 'Pula', countries: ['Botswana'] },
  BYN: {
    isoCode: '933',
    fractionDigit: 2,
  ...
  ERN: { isoCode: '232', fractionDigit: 2, currencyName: 'Nakfa', countries: ['Eritrea'] },
  ETB: {
    isoCode: '230',
    fractionDigit: 2,
  ...
  GEL: { isoCode: '981', fractionDigit: 2, currencyName: 'Lari', countries: ['Georgia'] },
  GHS: {
    isoCode: '936',
    fractionDigit: 2,
  ...
  HRK: { isoCode: '191', fractionDigit: 2, currencyName: 'Kuna', countries: ['Croatia'] },
  HTG: { isoCode: '332', fractionDigit: 2, currencyName: 'Gourde', countries: ['Haiti'] },
  HUF: { isoCode: '348', fractionDigit: 2, currencyName: 'Forint', countries: ['Hungary'] },
  IDR: {
    isoCode: '360',
    fractionDigit: 2,
    currencyName: 'Rupiah',
  ...
  JPY: { isoCode: '392', fractionDigit: 0, currencyName: 'Yen', countries: ['Japan'] },
  KES: {
    isoCode: '404',
    fractionDigit: 2,
  ...
  KGS: { isoCode: '417', fractionDigit: 2, currencyName: 'Som', countries: ['Kyrgyzstan'] },
  KHR: { isoCode: '116', fractionDigit: 2, currencyName: 'Riel', countries: ['Cambodia'] },
  KMF: {
    isoCode: '174',
    fractionDigit: 0,
  ...
  LSL: { isoCode: '426', fractionDigit: 2, currencyName: 'Loti', countries: ['Lesotho'] },
  LYD: {
    isoCode: '434',
    fractionDigit: 3,
  ...
  MMK: { isoCode: '104', fractionDigit: 2, currencyName: 'Kyat', countries: ['Myanmar'] },
  MNT: {
    isoCode: '496',
    fractionDigit: 2,
    currencyName: 'Tugrik',
  ...
  MOP: { isoCode: '446', fractionDigit: 2, currencyName: 'Pataca', countries: ['Macao'] },
  MRU: {
    isoCode: '929',
    fractionDigit: 2,
  ...
  NGN: { isoCode: '566', fractionDigit: 2, currencyName: 'Naira', countries: ['Nigeria'] },
  NIO: {
    isoCode: '558',
    fractionDigit: 2,
  ...
  PAB: { isoCode: '590', fractionDigit: 2, currencyName: 'Balboa', countries: ['Panama'] },
  PEN: { isoCode: '604', fractionDigit: 2, currencyName: 'Sol', countries: ['Peru'] },
  PGK: {
    isoCode: '598',
    fractionDigit: 2,
    currencyName: 'Kina',
  ...
  PLN: { isoCode: '985', fractionDigit: 2, currencyName: 'Zloty', countries: ['Poland'] },
  PYG: {
    isoCode: '600',
    fractionDigit: 0,
  ...
  THB: { isoCode: '764', fractionDigit: 2, currencyName: 'Baht', countries: ['Thailand'] },
  TJS: {
    isoCode: '972',
    fractionDigit: 2,
    currencyName: 'Somoni',
  ...
  TOP: { isoCode: '776', fractionDigit: 2, currencyName: 'Pa’anga', countries: ['Tonga'] },
  TRY: {
    isoCode: '949',
    fractionDigit: 2,
  ...
  VND: { isoCode: '704', fractionDigit: 0, currencyName: 'Dong', countries: ['Viet Nam'] },
  VUV: { isoCode: '548', fractionDigit: 0, currencyName: 'Vatu', countries: ['Vanuatu'] },
  WST: { isoCode: '882', fractionDigit: 2, currencyName: 'Tala', countries: ['Samoa'] },
  XAF: {
    isoCode: '950',
    fractionDigit: 0,
  ...
  XAU: { isoCode: '959', fractionDigit: 0, currencyName: 'Gold', countries: ['Zz08_gold'] },
  XBA: {
    isoCode: '955',
    fractionDigit: 0,
